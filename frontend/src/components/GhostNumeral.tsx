...
/** Large outlined stage numeral, green stroke with glow. Decorative. */
  ...
  return (
    <div
      ...
      style={{
        fontSize: size,
        color: 'transparent',
        WebkitTextStroke: '1px #22e35a',
        textShadow: '0 0 18px rgba(34,227,90,.35), 0 0 42px rgba(34,227,90,.18)',
        opacity: 0.75,
