...
export function ExportScreen() {
  ...
  const config = draft ? (
    <>
      <Panel title="Formats" kana="形式" actions={<span className="font-mono text-[10px] text-dim">{draft.formats.length} selected</span>}>
      ...
      <Panel title="Split & validation" kana="検証">
