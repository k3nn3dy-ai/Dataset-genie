...
export function Kit() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <Header kicker="COMPONENT KIT · EVERY PRIMITIVE" title="Kit" numeral="00" subtitle="Every primitive, rendered once. The RUN STAGE primary lives in the Buttons panel below." />
      <Panel title="Buttons">
        <div className="flex flex-wrap items-center gap-2">
          <Button variant="primary" icon="play">Run stage</Button><Button variant="steel" icon="sparkle">Steel</Button><Button variant="outline" icon="export">Outline</Button><Button variant="ghost" icon="refresh">Ghost</Button><Button variant="danger" icon="trash">Danger</Button>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Panel title="Tabs · Toggle · Slider · Chips">
          ...
          <div className="mt-4 flex flex-col gap-4">
            ...
            <Toggle checked={!on} onChange={(x) => setOn(!x)} label="Acid toggle" tone="ok" size="sm" />
        ...
        <Panel title="Fields · ModelPicker">
          <div className="flex flex-col gap-3">
            ...
            <Kicker text="STAGE 03 · THE TEACHER ANSWERS" />
